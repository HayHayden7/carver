...
public class QuartzPillarBlock extends CarverModElements.ModElement {
	@ObjectHolder("carver:quartz_pillar")
	public static final Block block = null;
	public QuartzPillarBlock(CarverModElements instance) {
		super(instance, 348);
	}
