...
public class BricksPillarBlock extends CarverModElements.ModElement {
	@ObjectHolder("carver:bricks_pillar")
	public static final Block block = null;
	public BricksPillarBlock(CarverModElements instance) {
		super(instance, 860);
	}
